      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 text-center">
        ...
        >
          <div className="relative max-w-4xl mx-auto px-4 sm:px-0">
            <div className="bg-white rounded-2xl shadow-2xl border border-warm-100 overflow-visible">
              <div className="flex items-center gap-2 px-4 py-3 bg-warm-50 border-b border-warm-100 rounded-t-2xl">
                <div className="w-3 h-3 rounded-full bg-red-400" />
                <div className="w-3 h-3 rounded-full bg-yellow-400" />
                <div className="w-3 h-3 rounded-full bg-green-400" />
              </div>
              <div className="relative w-full pb-[56.25%] bg-gradient-to-br from-warm-50 to-brand-50 rounded-b-2xl">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-brand-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                      <Play className="w-8 h-8 sm:w-10 sm:h-10 text-brand-600" />
                    </div>
                    <p className="text-warm-500 text-sm sm:text-base">Vidéo de démo</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-warm-400">Résultat client</p>
                </div>
              </div>
            </motion.div>
            <motion.div
  ...
  const categories = [
    {
      ...
      description: 'Tu peux parler de ton offre — il y a un signal d\'achat clair.',
    ...
    {
      icon: '🚫',
      title: 'Prospect à laisser de côté',
      description: 'Pas aligné avec toi — inutile de forcer.',
      color: 'bg-warm-100 border-warm-300 text-warm-700',
    },
  ];

  return (
    <section ref={ref} className="py-24 bg-gradient-to-br from-brand-50 to-accent-50">
      <div className="max-w-5xl mx-auto px-4">
        <motion.div
          initial="hidden"
          animate={isInView ? 'visible' : 'hidden'}
        ...
        >
          {categories.map((cat, index) => (
            <motion.div
              ...
              className={`rounded-2xl p-6 border-2 ${cat.color} text-center`}
            >
...
// ==========================================
// SECTION 4: POURQUOI LA PROSPECTION DM
// ==========================================
function WhyDMSection() {
  const { ref, isInView } = useScrollAnimation();
    ...
    <section ref={ref} className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="bg-gradient-to-br from-warm-50 to-warm-100 rounded-3xl p-8 md:p-12"
          >
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 bg-warm-200 rounded-2xl flex items-center justify-center flex-shrink-0">
                <TrendingUp className="w-6 h-6 text-warm-600" />
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-bold text-warm-900">
                Le constat
              </h2>
            </div>
            <p className="text-lg md:text-xl text-warm-700 leading-relaxed">
              La visibilité organique devient plus difficile sur les réseaux sociaux : plus de contenus, plus de posts sponsorisés, plus de concurrence pour chaque impression.
              <span className="block mt-4 font-semibold text-warm-900">
                Résultat : même un bon contenu ne suffit plus pour générer des opportunités.
              </span>
            </p>
          </motion.div>
          ...
          <motion.div
            variants={fadeInUp}
            className="bg-gradient-to-br from-brand-50 to-accent-50 rounded-3xl p-8 md:p-12 border-2 border-brand-200"
          >
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 bg-brand-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                <Target className="w-6 h-6 text-brand-600" />
              </div>
              <h2 className="font-display text-2xl md:text-3xl font-bold text-brand-700">
                La solution : la prospection DM
              </h2>
            </div>
            <p className="text-lg md:text-xl text-warm-700 leading-relaxed">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <p className="text-warm-600 mb-8 text-center">
            Prospection par DM t'aide à prospecter INTELLIGEMMENT.
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="pt-8 border-t border-warm-800 text-sm text-center">
          ...
          <p className="text-warm-600">
            ...
            Prospection par DM n'est pas affilié à Meta ou TikTok.
          </p>
        </div>
      </div>
    </footer>
